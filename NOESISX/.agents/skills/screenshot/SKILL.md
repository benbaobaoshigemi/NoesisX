...
```bash
python3 <path-to-skill>/scripts/take_screenshot.py --path scratch/screen.png
```
...
```bash
screencapture -x scratch/screen.png
```

- Pixel region:

```bash
screencapture -x -R100,200,800,600 scratch/region.png
```

- Specific window id:

```bash
screencapture -x -l12345 scratch/window.png
```

- Interactive selection or window pick:

```bash
screencapture -x -i scratch/interactive.png
```
...
```bash
scrot scratch/screen.png
```

```bash
gnome-screenshot -f scratch/screen.png
```

```bash
import -window root scratch/screen.png
```

- Pixel region:

```bash
scrot -a 100,200,800,600 scratch/region.png
```

```bash
import -window root -crop 800x600+100+200 scratch/region.png
```

- Active window:

```bash
scrot -u scratch/window.png
```

```bash
gnome-screenshot -w -f scratch/window.png
```
